...
export default function Chat() {
  ...
  const fetchConversations = async () => {
    try {
      const res = await axios.get('https://fuzzy-geese-lay.loca.lt' + '/api/chat/conversations');
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('https://fuzzy-geese-lay.loca.lt' + '/api/chat/ask', {
        message: userMessage,
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const response = await axios.post('https://fuzzy-geese-lay.loca.lt' + '/api/dataset/upload', formData, {
