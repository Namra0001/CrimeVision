...
export default function ForgotPassword() {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://crimevision-api.loca.lt' + '/api/auth/forgot-password', {
        method: 'POST',
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://crimevision-api.loca.lt' + '/api/auth/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
